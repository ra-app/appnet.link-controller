...
if [ "$2" == "genca" ]; then
    openssl req -x509 -nodes -days 3680 -subj "/C=CN/ST=Shanghai/L=Shanghai/OU=de.webconnect.pro/CN=$1" -newkey rsa:4096 -keyout ./ca-certs/ca-key.pem -out ./ca-certs/ca-cert.pem
...
openssl req -new -key ./certs/as-key.pem -subj "/C=CN/ST=Shanghai/L=Shanghai/OU=de.webconnect.pro/CN=$1" -out ./certs/as-csr.pem
...
openssl req -new -key ./certs/ps-key.pem -subj "/C=CN/ST=Shanghai/L=Shanghai/OU=de.webconnect.pro/CN=$1" -out ./certs/ps-csr.pem
...
openssl req -new -key ./certs/ns-key.pem -subj "/C=CN/ST=Shanghai/L=Shanghai/OU=de.webconnect.pro/CN=$1" -out ./certs/ns-csr.pem
