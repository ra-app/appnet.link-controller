...
// openssl req  -x509 -nodes -days 365 -subj '/C=CN/ST=SH/L=SH/CN=de.webconnect.pro' -newkey rsa:2048 -keyout server-key.pem -out server-cert.pem
...
// - openssl genrsa -out server-key.pem 2048  
// - openssl req -new -key server-key.pem -subj '/C=CN/ST=SH/L=SH/CN=de.webconnect.pro' -out server-csr.pem  
...
// --- openssl req -new -x509 -days 1868 -subj '/C=CN/ST=SH/L=SH/CN=de.webconnect.pro' -key ca-key.pem -out ca-cert.pem
// --
// -- server cert:
...
/*(function(){
    genSslCertCA('browser-iwebpp', {
                ...
                days: 666,
                cn: 'de.webconnect.pro',
                altname: ['vurl.de.webconnect.pro', '*.vurl.de.webconnect.pro', '127.0.0.1']
    },
    function(err, certs){
        if (err) {
